...
const DeviceCard = React.memo(function DeviceCard({
	...
	return (
        ...
        `}</style>
			...
			<div
				className={clsx(
					"relative flex flex-col overflow-hidden border transition-all duration-700",
					width,
...
// --- Dashboard --------------------------------------------------------
export default function RhTempDashboard({
	...
	return (
		...
		>
			...
			<div className="col-span-9 flex flex-wrap justify-center mb-10 gap-2 animate-slideup">
