...
export default function TimeLine({ ranges, height = 60 }) {
    ...
    const currentHour = 9.2;

    // Check if pointer is in any range
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="p-2 font-bold">
                {inRange ? (
                    <span className="text-primary">
                        You are within the allowed time. You can update the
                        checklist now.
                    </span>
                ) : (
                    <span className="text-error">
                        Updates are outside the allowed time. You can still
                        proceed if needed, but it’s outside the normal window.
                    </span>
                )}
            </div>
            <svg
            ...
            >
                ...
                <g
                    transform={`translate(${hourToX(currentHour)}, ${
                        height / 2
                    })`}
                >
                    {/* Circle */}
